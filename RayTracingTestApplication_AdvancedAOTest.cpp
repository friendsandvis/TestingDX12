...
void RayTracingTestApplication_AdvancedAOTest::RenderRT()
{
...
void RayTracingTestApplication_AdvancedAOTest::InitGbufferPSO()
{
...
void RayTracingTestApplication_AdvancedAOTest::InitRTDisplayPSO()
{
...
void RayTracingTestApplication_AdvancedAOTest::InitGBufferDisplayPSO()
{
	PSOInitData basicpsodata = {};
	basicpsodata.type = GRAPHICS;
...
void RayTracingTestApplication_AdvancedAOTest::InitRTPSO()
{
	...
	m_simplertpso.SetPipelineConfig(5);
	{
	...
	//upload actual data to shader recods
	{
		...
		{
			BasicShaderRecord records[NUMMISSSHADERRECORDS] = {};
			{
			...
			memcpy(mappedbuffer, records, sizeof(records));
		...
		//pass hit group records to buffer
		{
			...
			BasicShaderRecord records[NUMHITGROUPRECORDS] = {};
			{
			...
			unsigned memsizetocpy = sizeof(records);
...
void RayTracingTestApplication_AdvancedAOTest::InitPSO_RTRaster()
{
...
void RayTracingTestApplication_AdvancedAOTest::ProcessWindowProcEvent(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	if (uMsg == WM_CHAR)
	{
